...
- slopes of N(0,1) for all 4 predictors (income, building period, SVI, and pediatrician rate)
In the poisson:
- intercept of N(-1.58,2) based on the NHANES national average of 2.6%
- slopes of N(0,0.6) for all intercepts - for higher variances some observations go beyond the rate tolerance - except income and the building period, which I center -0.1 and 0.1 respectively.
