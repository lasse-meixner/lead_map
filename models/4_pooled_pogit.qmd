...
Running the above model, the generated quantities block throws a ton of exceptions because the poisson rate parameter is too large. So something is definitely very wrong with the model. Looking at the posteriors, this could only happen because the offsets pushes it out of sensible ranges...
