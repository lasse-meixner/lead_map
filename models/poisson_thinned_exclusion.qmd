...
stan_model_x_in_logit <- cmdstan_model("poisson_thinned_exclusion_x_logit.stan")
...
Similar to the simulation from learn_bayes we see that the uncertainty is greater, and that there appears to be some identification issues.
