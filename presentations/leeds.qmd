...
## Calculation of IMD Health Disability score
...
1. Years of potential life lost
  - Age standardised measure of premature death
2. Comparative Illness and Disability Ratio
  - An age and sex-standardized morbidity/disability ratio.
3. Acute Morbidity
  - An age and sex-standardized rate of emergency hospital admissions.
4. Mood and Anxiety Disorders
  - A composite measure derived from:
  - Hospital episode data
  - Prescribing data
  - Suicide mortality data

## Calculation of IMD Housing Services Score
...
Indicators for geographical barriers:
- Mean road distance to the closest post office for people living at the LSOA level.
- Mean road distance to the closest primary school for people living at the LSOA level.
- Mean road distance to the closest supermarket or general store for people living at the LSOA level.
- Mean road distance to the closest GP surgery for people living at the LSOA level.

Indicators for wider barriers: 
- The proportion of all households at the LSOA level judged to have insufficient space to meet the household’s needs.
- The LAD-level rate of acceptances for housing assistance under the homelessness provisions of the 1996 Housing Act, assigned to the constituent LSOA.


## Calculation of IMD overall score
The IMD combines information from the seven domains to produce an overall relative measure of deprivation:
- Income score (22.5%)
