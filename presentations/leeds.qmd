...
We use the UK Stock of properties data to obtain the proportion of houses built in various intervals.<br>
The most granular scale at which this data is collected is the LSOA level.<br>
