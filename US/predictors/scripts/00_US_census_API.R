...
get_census_data_us <- function(geography_type) {
  ...
  acs <- get_acs(geography = geography_type,
    ...
    mutate(renter_occupied_hu_propE = renter_occupied_huE / total_occupied_huE, 
           ...
           under_yo5_ppl_propE = under_yo5_male_pplE + under_yo5_female_pplE, 
           yo5to9_ppl_propE = yo5to9_male_pplE + yo5to9_female_pplE,
           yo10to14_ppl_propE = yo10to14_male_pplE + yo10to14_female_pplE,
           yo15to17_ppl_propE = yo15to17_male_pplE + yo15to17_female_pplE,
           ...
           across(.cols = under_yo5_ppl_propE:yo15to17_ppl_propE, .fns = ~. / total_ppl_u17E),
